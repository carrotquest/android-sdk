...
dependencies {
    ...
    implementation 'io.carrotquest:android-sdk:1.0.34-commonRelease'
}
```
...
![Api keys](https://github.com/carrotquest/android-sdk/blob/beta/img/carrot_api_keys.png?raw=true)
